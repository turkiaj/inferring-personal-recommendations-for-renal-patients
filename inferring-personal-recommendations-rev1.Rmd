  ...
  if (file.exists(accepted_intake)) {
    ...
    else
    {
      ...
      intake_plot <- ggplot(subset(accepted_intake.df, lowest_conc_prob >= 0.50), aes(x = pot, y = pho)) +
        geom_point(aes(colour=lowest_conc_prob), show.legend = TRUE) +
        theme(legend.position="bottom", axis.text = element_text(size=6), axis.title = element_text(size=7), plot.title = element_text(size=7)) + 
        theme(text = element_text(family = "Times New Roman")) +
        ...
        guides(colour = guide_colorbar(title = "Probability % of reaching target concentrations", title.theme = element_text(size=6, family = "Times New Roman"), label.theme = element_text(size=5, family = "Times New Roman"), title.position = "top", barwidth = unit(80,"mm"))) +
        ...
        geom_segment(aes(xend = 5700, x = 5000, yend = 125, y = 125), color="#333333", size=0.15, arrow = arrow(type = "closed", length = unit(0.06, "inches"))) +
        annotate("label", x = 3500, y = 115, label = "Point of observed intake that produced\nthe concentrations with dashed lines", size=2, vjust = "middle")    
      ...
      pk_plot <- ggplot(concs_minmax.df, aes(x = pk, group=factor(color_order))) +
        ...
        theme_bw() +
        theme(text = element_text(family = "Times New Roman")) +
        theme(axis.text.x = element_text(size=6), axis.title = element_text(size=7), plot.title = element_text(size=9), axis.text.y = element_blank()) 
      ...
      palb_plot <- ggplot(concs_minmax.df, aes(x = palb, color=factor(color_order), group=factor(color_order))) +
        ...
        theme_bw() +
        theme(text = element_text(family = "Times New Roman")) +
        theme(legend.position="bottom", legend.title = element_blank(), axis.text.x = element_text(size=6), axis.title = element_text(size=7), plot.title = element_text(size=9), axis.text.y = element_blank())
...
p <- mebn.multivariate_dens_overlays("models/BLMM_gamma_mv_cross/two_levels/", assumedtargets, dialysis) 
p

sumstats <- summary(twolvl_fit)
