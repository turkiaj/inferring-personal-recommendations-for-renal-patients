...
ggplot(error_analysis.df) +
  geom_point(aes(y = reorder(subject, patient_id), x = avg_error), color = "#799fcb") +
  geom_point(aes(y = subject, x = avg_cv_error), color = "#f9665e") +
  geom_line(aes(y = subject, x = avg_cv_error), color = "#f9665e") +
  geom_segment(aes(y = reorder(subject, patient_id), yend = subject, x = avg_error, xend = avg_cv_error, group = subject, color = fold_color), linetype = "solid") +
  theme_bw() +
