...
saveRDS(mse_summary, "model_evaluation/NRMSE_comparison_mv_cv_models.rds")

write.csv2(mse_summary, file="model_evaluation/NRMSE_comparison_mv_cv_models.csv", row.names = FALSE)
